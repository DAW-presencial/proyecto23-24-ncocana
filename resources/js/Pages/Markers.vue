        ...
        <main class="flex-1 p-5">
            <div class="flex flex-col max-w-7xl mx-auto">
                ...
                <div class="flex justify-between">
                    <div class="w-32">
                        <PrimaryButton>Create marker</PrimaryButton>
                    </div>
                    <div class="flex gap-4">
                        <TextInput></TextInput>
                        <PrimaryButton class="w-32">Buscar</PrimaryButton>
                    </div>
                </div>
                <div
                    class="flex justify-between border border-gray-300 shadow-md mt-4 gap-10 p-6 rounded-md min-h-screen">
                    <div class='flex flex-col w-3/4 border border-gray-300 rounded-sm'>
                        <!-- Cards -->
                        <Card v-for="b in books" :key="b">
                    ...
                    <div class='w-1/4 border border-gray-300 rounded-sm'>
...
onMounted(() => {
    document.title = "Markers | MyBookMarks";
});
</script>
